...
class TestCreateDataset(unittest.TestCase):
    ...
    def test_pairs_should_match(self):
        ...
        self.validate_pairs(self.pairs_valid)
    ...
    def test_different_and_same_should_have_same_length(self):
        ...
        self.assertEqual(len(list(list_file_pairs(part='same', root='/home/daniel/data_dogs/validation'))), len(list(list_file_pairs(part='different', root='/home/daniel/data_dogs/validation'))))
